...
import { Smartphone, RotateCw, Maximize, Sparkles } from 'lucide-react';
          ...
          >
            ...
            <div className="relative mb-8 flex items-center justify-center">
              <motion.div
                ...
                className="w-24 h-40 rounded-2xl border-2 border-[#ebd09b] bg-[#141019] shadow-[0_0_35px_rgba(197,168,128,0.35)] flex flex-col items-center justify-between p-2 relative"
              >
                {/* Speaker pill */}
              ...
              <motion.div
                ...
                className="absolute -top-4 -right-4 w-10 h-10 rounded-full bg-[#c5a880]/15 border border-[#c5a880]/40 flex items-center justify-center text-[#ebd09b]"
              >
            ...
            <div className="max-w-sm space-y-3 relative z-10">
              ...
              <p className="font-serif italic text-xs text-gray-400 leading-relaxed">
                Для тактических сражений 5х5, точного розыгрыша карт и чтения рунических навыков поверните телефон горизонтально.
              </p>
            </div>

            {/* Fullscreen request button if supported */}
            <button
