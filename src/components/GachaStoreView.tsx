...
export const GachaStoreView: React.FC<GachaStoreViewProps> = ({ initialTab = 'cards' }) => {
  ...
  // Buy Divine Card (costs 2,500 Shards)
  ...
  // Buy Divine Equipment (costs 600 Shards)
  ...
  // Buy Full Demiurge Set (discounted 3,000 Shards instead of 3,600)
  ...
  return (
    <div className="max-w-7xl mx-auto px-2 sm:px-4 pt-2 sm:pt-3 pb-1">
      ...
      <div className="flex flex-col md:flex-row gap-4 lg:gap-5 items-stretch">
        ...
        <div className="w-full md:w-64 lg:w-72 shrink-0 bg-gradient-to-b from-[#121620]/95 via-[#0c0f16]/95 to-[#08090e]/95 border border-amber-500/20 rounded-2xl p-2.5 sm:p-3 flex flex-row md:flex-col gap-2 sm:gap-2.5 shadow-2xl backdrop-blur-md overflow-x-auto md:overflow-y-auto md:overflow-x-hidden md:max-h-[calc(100vh-140px)] custom-scrollbar relative">
          ...
          <div className="hidden md:flex items-center justify-center py-2.5 px-3 border-b border-amber-500/20 mb-1 sticky top-0 bg-[#0e121a]/95 backdrop-blur-md z-20 shrink-0 -mx-1">
          ...
          >
            <div className="flex items-center gap-3 min-w-0">
              <div className={`w-12 h-12 rounded-xl p-1 flex items-center justify-center border shrink-0 relative overflow-hidden transition-all group-hover:scale-105 ${
                ...
                <img
                  src="/shop/ascension_sigil.png"
                  alt="Ascension"
                  className={`w-9 h-9 object-contain relative z-10 transition-transform ${activeCategory === 'level_boost' ? 'scale-110 drop-shadow-[0_0_8px_rgba(245,158,11,0.9)]' : 'opacity-80 group-hover:opacity-100'}`}
                />
              </div>
              <div className="min-w-0">
                <div className="flex items-center gap-1.5">
                ...
                <div className="bg-gradient-to-b from-[#1c150e] via-[#120e09] to-[#0a0705] border-2 border-amber-600/40 hover:border-amber-400/90 rounded-2xl p-3 sm:p-3.5 flex flex-col justify-between shadow-xl hover:shadow-[0_0_30px_rgba(245,158,11,0.25)] transition-all duration-300 group relative overflow-hidden">
                  ...
                  <div className="mt-2.5 sm:mt-3 relative z-10">
                    <button
                      ...
                      className="w-full relative overflow-hidden bg-gradient-to-b from-[#3d2410] via-[#241407] to-[#120a03] hover:from-[#4d2d14] hover:via-[#2e1909] hover:to-[#170c04] border-t-2 border-t-amber-400/90 border-x border-amber-600/50 border-b-2 border-b-black font-display font-black tracking-widest py-2 px-3 rounded-xl transition-all duration-200 shadow-[0_4px_12px_rgba(0,0,0,0.8),0_0_12px_rgba(245,158,11,0.2)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.9),0_0_18px_rgba(245,158,11,0.35)] flex items-center justify-between text-xs cursor-pointer hover:scale-[1.01] active:scale-[0.98] select-none group"
                    >
                ...
                <div className="bg-gradient-to-b from-[#0a1824] via-[#06111a] to-[#030a10] border-2 border-cyan-500/40 hover:border-cyan-400/90 rounded-2xl p-3 sm:p-3.5 flex flex-col justify-between shadow-xl hover:shadow-[0_0_30px_rgba(6,182,212,0.25)] transition-all duration-300 group relative overflow-hidden">
                  ...
                  <div className="mt-2.5 sm:mt-3 relative z-10">
                    <button
                      ...
                      className="w-full relative overflow-hidden bg-gradient-to-b from-[#0f3542] via-[#082029] to-[#030e13] hover:from-[#144354] hover:via-[#0b2b37] hover:to-[#05141b] border-t-2 border-t-cyan-300/90 border-x border-cyan-500/50 border-b-2 border-b-black font-display font-black tracking-widest py-2 px-3 rounded-xl transition-all duration-200 shadow-[0_4px_12px_rgba(0,0,0,0.8),0_0_12px_rgba(6,182,212,0.2)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.9),0_0_18px_rgba(6,182,212,0.35)] flex items-center justify-between text-xs cursor-pointer hover:scale-[1.01] active:scale-[0.98] select-none group"
                    >
                ...
                <div className="bg-gradient-to-b from-[#240810] via-[#16050b] to-[#0c0205] border-2 border-rose-500/50 hover:border-rose-400/95 rounded-2xl p-3 sm:p-3.5 flex flex-col justify-between shadow-xl hover:shadow-[0_0_35px_rgba(244,63,94,0.3)] transition-all duration-300 group relative overflow-hidden">
                  ...
                  <div className="space-y-2.5 sm:space-y-3 relative z-10">
                    ...
                    <div>
                      <h4 className="font-display font-black text-sm sm:text-base text-white group-hover:text-rose-300 transition-colors">
                        Abyssal Booster Pack
                      </h4>
                      <p className="text-[9.5px] text-gray-400 font-sans mt-0.5 leading-tight">Elite void entities and elder primordial forces</p>
                    </div>
                    ...
                    <div className="bg-black/65 border border-white/10 rounded-xl p-2.5 text-[11px] font-mono space-y-1.5 shadow-inner">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-cyan-300 font-bold text-xs bg-cyan-950/60 px-1.5 py-0.5 rounded border border-cyan-500/40">55%</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-gray-300 flex items-center gap-1.5">
                          <span className="w-1.5 h-1.5 rounded-full bg-amber-400" />
                      ...
                      <div className="flex justify-between items-center border-t border-white/10 pt-1.5 text-gray-400 text-[10.5px]">
                        <span className="flex items-center gap-1 text-rose-300/80">
                          <Sparkles className="w-3 h-3 text-rose-400" /> Legendary Cards:
                        </span>
                        <span className="text-rose-300 font-bold bg-rose-950/80 px-1.5 py-0.5 rounded border border-rose-500/40">10%</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-2.5 sm:mt-3 relative z-10">
                    <button
                      ...
                      className="w-full relative overflow-hidden bg-gradient-to-b from-[#4e101d] via-[#2d0710] to-[#140206] hover:from-[#611424] hover:via-[#390914] hover:to-[#1a0308] border-t-2 border-t-rose-400/90 border-x border-rose-500/50 border-b-2 border-b-black font-display font-black tracking-widest py-2 px-3 rounded-xl transition-all duration-200 shadow-[0_4px_12px_rgba(0,0,0,0.8),0_0_12px_rgba(244,63,94,0.2)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.9),0_0_18px_rgba(244,63,94,0.35)] flex items-center justify-between text-xs cursor-pointer hover:scale-[1.01] active:scale-[0.98] select-none group"
                    >
            ...
            <div className="space-y-3 sm:space-y-3.5">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1.5 border-b border-purple-950/80 pb-2">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <h2 className="font-display font-black text-sm sm:text-base text-white tracking-wider uppercase text-shadow">
                        Relic Armory Chests
                      </h2>
                      <span className="bg-purple-950/90 border border-purple-500/60 text-purple-300 text-[8px] font-mono px-2 py-0.5 rounded font-black tracking-widest uppercase shadow-[0_0_8px_rgba(168,85,247,0.3)]">
                        3 TIERS
                      </span>
                    </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-3.5">
                ...
                {/* Basic Chest */}
                <div className="bg-gradient-to-b from-[#14120a] via-[#0d0c07] to-[#070604] border-2 border-amber-800/40 hover:border-amber-600/70 rounded-2xl p-3 sm:p-3.5 flex flex-col justify-between shadow-xl hover:shadow-[0_0_25px_rgba(217,119,6,0.2)] transition-all duration-300 group relative overflow-hidden">
                  <div className="space-y-2.5 sm:space-y-3 relative z-10">
                    <div className="flex items-center justify-between text-[8.5px] font-mono font-bold tracking-wider text-amber-500/90 uppercase px-1">
                      <span className="flex items-center gap-1.5">
                        <span className="w-1.5 h-1.5 rounded-full bg-amber-500" />
                        INITIATE RELICS
                      </span>
                      <span className="bg-black/60 border border-amber-700/40 px-1.5 py-0.2 rounded text-[7.5px] text-amber-400">
                        RANK I
                      </span>
                    </div>

                    <div className="h-38 sm:h-42 rounded-xl bg-gradient-to-b from-amber-950/30 via-black/60 to-black/80 border border-amber-800/30 flex flex-col items-center justify-center relative overflow-hidden group-hover:border-amber-700/50 transition-colors shadow-inner">
                      ...
                      <img 
                        ...
                        alt="Basic Relics" 
                        decoding="async" 
                        className="w-32 h-32 sm:w-36 sm:h-36 object-contain group-hover:scale-105 transition-transform duration-500 drop-shadow-[0_0_15px_rgba(217,119,6,0.35)]" 
                      />
                      <div className="absolute bottom-1.5 px-2.5 py-0.5 rounded-full bg-black/80 border border-amber-700/50 backdrop-blur-sm shadow-md">
                        <span className="font-display font-black text-[9px] text-amber-300 tracking-widest uppercase">
                          STANDARD GEAR
                        </span>
                      </div>
                    ...
                    <div>
                      ...
                      <p className="text-[9.5px] text-gray-400 font-sans mt-0.5 leading-tight">Forged for frontline warriors and acolytes</p>
                    </div>
                    ...
                    <div className="bg-black/65 border border-white/10 rounded-xl p-2.5 text-[11px] font-mono space-y-1.5 shadow-inner">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-amber-200 font-bold text-xs bg-amber-950/60 px-1.5 py-0.5 rounded border border-amber-800/40">70%</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-gray-300 flex items-center gap-1.5">
                          <span className="w-1.5 h-1.5 rounded-full bg-cyan-400" />
                        ...
                        <span className="text-cyan-300 font-bold text-xs bg-cyan-950/60 px-1.5 py-0.5 rounded border border-cyan-500/40">25%</span>
                      </div>
                      <div className="flex justify-between items-center border-t border-white/10 pt-1.5 text-gray-400 text-[10.5px]">
                        <span className="flex items-center gap-1 text-amber-400/80">
                          <Sparkles className="w-3 h-3 text-amber-400" /> Gold Equipment:
                        </span>
                        <span className="text-amber-300 font-bold bg-amber-950/80 px-1.5 py-0.5 rounded border border-amber-500/40">5%</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-2.5 sm:mt-3 relative z-10">
                    <button
                      ...
                      className="w-full relative overflow-hidden bg-gradient-to-b from-[#2e1d0d] via-[#1c1108] to-[#0c0703] hover:from-[#3a2511] hover:via-[#24160a] hover:to-[#100904] border-t-2 border-t-amber-500/90 border-x border-amber-700/50 border-b-2 border-b-black font-display font-black tracking-widest py-2 px-3 rounded-xl transition-all duration-200 shadow-[0_4px_12px_rgba(0,0,0,0.8),0_0_12px_rgba(217,119,6,0.2)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.9),0_0_18px_rgba(217,119,6,0.35)] flex items-center justify-between text-xs cursor-pointer hover:scale-[1.01] active:scale-[0.98] select-none group"
                    >
                      <span className="font-display font-black tracking-widest text-amber-200 group-hover:text-amber-100 drop-shadow-[0_1px_2px_rgba(0,0,0,0.9)]">
                        FORGE RELIC
                      </span>
                ...
                {/* Rare Chest */}
                <div className="bg-gradient-to-b from-[#0c222c] via-[#07161d] to-[#030b0e] border-2 border-cyan-500/50 hover:border-cyan-400/95 rounded-2xl p-3 sm:p-3.5 flex flex-col justify-between shadow-xl hover:shadow-[0_0_30px_rgba(6,182,212,0.25)] transition-all duration-300 group relative overflow-hidden">
                  <div className="absolute -top-24 -left-24 w-48 h-48 bg-cyan-500/15 rounded-full blur-2xl pointer-events-none group-hover:bg-cyan-500/25 transition-all" />
                  ...
                  <div className="space-y-2.5 sm:space-y-3 relative z-10">
                    <div className="flex items-center justify-between text-[8.5px] font-mono font-bold tracking-wider text-cyan-400/90 uppercase px-1">
                      ...
                      <span className="bg-cyan-950/80 border border-cyan-500/50 px-1.5 py-0.2 rounded text-[7.5px] text-cyan-300">
                        RANK II
                      </span>
                    </div>
                    ...
                    <div className="h-38 sm:h-42 rounded-xl bg-gradient-to-b from-cyan-950/40 via-black/60 to-black/80 border border-cyan-600/30 flex flex-col items-center justify-center relative overflow-hidden group-hover:border-cyan-400/60 transition-colors shadow-inner">
                      ...
                      <img 
                        ...
                        alt="Rare Relics" 
                        decoding="async" 
                        className="w-32 h-32 sm:w-36 sm:h-36 object-contain group-hover:scale-105 transition-transform duration-500 drop-shadow-[0_0_18px_rgba(6,182,212,0.4)]" 
                      />
                      <div className="absolute bottom-1.5 px-2.5 py-0.5 rounded-full bg-black/80 border border-cyan-500/50 backdrop-blur-sm shadow-md">
                        <span className="font-display font-black text-[9px] text-cyan-300 tracking-widest uppercase">
                          RARE WEAPONS
                    ...
                    <div>
                      ...
                      <p className="text-[9.5px] text-gray-400 font-sans mt-0.5 leading-tight">Infused with Void ether to overwhelm champions</p>
                    </div>
                ...
                <div className="bg-gradient-to-b from-[#21092a] via-[#14051a] to-[#0a020d] border-2 border-purple-500/50 hover:border-amber-400/90 rounded-2xl p-3 sm:p-3.5 flex flex-col justify-between shadow-xl hover:shadow-[0_0_35px_rgba(168,85,247,0.3)] transition-all duration-300 group relative overflow-hidden">
                  ...
                  <div className="mt-2.5 sm:mt-3 relative z-10">
                    <button
                      ...
                      className="w-full relative overflow-hidden bg-gradient-to-b from-[#3a154d] via-[#230b2f] to-[#100316] hover:from-[#491b61] hover:via-[#2d0e3c] hover:to-[#15041c] border-t-2 border-t-purple-400/90 border-x border-purple-500/50 border-b-2 border-b-black font-display font-black tracking-widest py-2 px-3 rounded-xl transition-all duration-200 shadow-[0_4px_12px_rgba(0,0,0,0.8),0_0_12px_rgba(168,85,247,0.2)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.9),0_0_18px_rgba(168,85,247,0.35)] flex items-center justify-between text-xs cursor-pointer hover:scale-[1.01] active:scale-[0.98] select-none group"
                    >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-5">
                {CARD_TEMPLATES.filter(c => c.tier === 'divine').map((card) => {
                  ...
                  return (
                    <div 
                      key={card.baseId} 
                      className="bg-gradient-to-b from-[#240810] via-[#16050b] to-[#0c0205] border-2 border-rose-500/50 hover:border-rose-400/90 rounded-2xl p-4 flex flex-col justify-between shadow-2xl hover:shadow-[0_0_40px_rgba(244,63,94,0.35)] transition-all duration-300 group relative overflow-hidden"
                    >
                      {/* Ambient Glow behind card */}
                      <div className="absolute top-0 right-0 w-48 h-48 bg-rose-500/15 rounded-full blur-3xl pointer-events-none group-hover:bg-rose-500/25 transition-all" />

                      <div className="space-y-3 relative z-10">
                        {/* Top Tier Tag */}
                        <div className="flex items-center justify-between text-[10px] font-mono font-bold tracking-wider text-rose-400/90 uppercase px-1">
                          <span className="flex items-center gap-1.5">
                            <span className="w-2 h-2 rounded-full bg-rose-400 animate-pulse" />
                            PRIMORDIAL TIER
                          </span>
                          <span className="bg-rose-950/80 border border-rose-500/50 px-2 py-0.5 rounded text-[8.5px] text-rose-300">
                            {ownedCount > 0 ? `${ownedCount} OWNED` : 'UNACQUIRED'}
                          </span>
                        </div>
                      ...
                      <div className="mt-4">
                        <button
                          ...
                          className="w-full relative overflow-hidden bg-gradient-to-b from-[#4e101d] via-[#2d0710] to-[#140206] hover:from-[#611424] hover:via-[#390914] hover:to-[#1a0308] border-t-2 border-t-rose-400/90 border-x border-rose-500/50 border-b-2 border-b-black font-display font-black tracking-widest py-2.5 px-3.5 rounded-xl transition-all duration-200 shadow-[0_4px_12px_rgba(0,0,0,0.8),0_0_12px_rgba(244,63,94,0.2)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.9),0_0_18px_rgba(244,63,94,0.35)] flex items-center justify-between text-xs uppercase cursor-pointer hover:scale-[1.01] active:scale-[0.98] select-none group disabled:opacity-50"
                        >
                          <span className="font-display font-black tracking-widest text-rose-200 group-hover:text-rose-100 drop-shadow-[0_1px_2px_rgba(0,0,0,0.9)]">
                            {isBuyingThis ? 'INVOKING...' : 'SUMMON ENTITY'}
                          </span>
                          <div className="bg-black/60 border border-rose-500/40 rounded-lg px-2.5 py-1 flex items-center gap-1.5 shadow-inner">
                            <img src="/icons/icon_shards.webp" alt="Shards" className="w-4 h-4 object-contain filter drop-shadow-[0_0_6px_rgba(244,63,94,0.95)]" />
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 border-b border-rose-950/60 pb-2.5">
                  ...
                  <button
                    ...
                    className={`px-3.5 py-2 rounded-xl font-display font-black text-xs tracking-wider transition-all flex items-center shadow-lg active:scale-95 group ${
                      ownedDemiurgeCount === 6
                        ? 'bg-emerald-950/60 border-2 border-emerald-500/50 text-emerald-300 gap-2 cursor-default opacity-85'
                        : isBuyingSet
                        ? 'bg-gradient-to-b from-[#4d1f0f] via-[#2f0c16] to-[#18040a] border-t-2 border-t-amber-300 border-x border-amber-500/60 border-b-2 border-b-black text-white gap-2 cursor-wait'
                        : 'bg-gradient-to-b from-[#4d1f0f] via-[#2f0c16] to-[#18040a] hover:from-[#5e2713] hover:via-[#3a101c] hover:to-[#1e060d] border-t-2 border-t-amber-300 border-x border-amber-500/60 border-b-2 border-b-black text-white shadow-[0_4px_14px_rgba(0,0,0,0.8),0_0_16px_rgba(245,158,11,0.25)] hover:shadow-[0_4px_18px_rgba(0,0,0,0.9),0_0_22px_rgba(245,158,11,0.4)] gap-3 cursor-pointer hover:scale-[1.02]'
                    }`}
                  >
                    {ownedDemiurgeCount === 6 ? (
                      <span className="text-emerald-300">FULL SET ASSEMBLED (6/6)</span>
                    ) : isBuyingSet ? (
                      <span className="text-amber-200">FORGING ENTIRE SET...</span>
                    ) : (
                      <>
                        <span className="text-amber-100 group-hover:text-amber-50 font-display font-black tracking-wider drop-shadow-[0_1px_2px_rgba(0,0,0,0.9)]">
                          BUY FULL SET (6 PIECES)
                        </span>
                        <div className="bg-black/60 border border-amber-500/40 rounded-lg px-2 py-0.5 flex items-center gap-1.5 shadow-inner">
                          ...
                          <span className="line-through text-gray-400 font-mono text-[11px] font-bold">3,600</span>
                  ...
                  return (
                    ...
                    >
                      ...
                      <button
                        ...
                        className={`w-full relative overflow-hidden font-display font-black text-xs tracking-widest uppercase flex items-center justify-between py-2.5 px-3.5 rounded-xl transition-all duration-200 select-none group ${
                          isPurchasing
          ...
          {activeCategory === 'level_boost' && (
            <div className="space-y-2.5 sm:space-y-3 animate-fade-in">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1.5 border-b border-amber-500/20 pb-2">
                <div className="flex items-center gap-2.5">
                  <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br from-amber-500/20 via-black to-amber-950/50 border border-amber-400/50 flex items-center justify-center shadow-[0_0_14px_rgba(245,158,11,0.3)] shrink-0 overflow-hidden">
                    <img
                      src="/shop/ascension_sigil.png"
                      alt="Ascension Sigil"
                  ...
                  <div>
                    <h2 className="font-display font-black text-base sm:text-lg text-white tracking-widest text-shadow-gold uppercase flex items-center gap-2">
                      <span>Instant Ascension</span>
                      <span className="bg-amber-950/80 border border-amber-500/40 px-1.5 py-0.2 rounded text-[8px] text-amber-300 font-mono tracking-wider hidden sm:inline">
                        VIP TRANSCENDENCE
                      </span>
                    </h2>
                ...
                <div className="flex items-center gap-2 self-start sm:self-auto bg-black/60 border border-amber-500/30 px-2.5 py-1 rounded-xl font-mono text-xs shrink-0">
                  <span className="text-gray-400 text-[9.5px] uppercase font-bold tracking-wider">HERO LEVEL:</span>
                  <span className="text-amber-300 font-black text-xs sm:text-sm drop-shadow-[0_0_6px_rgba(245,158,11,0.6)]">LVL {profile.level || 1}</span>
                </div>
              </div>
                      ...
                      <div className="mt-3 pt-2.5 border-t border-white/10 relative z-10">
                        {isAlreadyReached ? (
                          ...
                          <button
                            ...
                            className={`w-full relative overflow-hidden py-2.5 px-3.5 rounded-xl font-display font-black text-xs sm:text-sm tracking-widest uppercase flex items-center justify-between transition-all duration-200 cursor-pointer select-none group ${
                              isProcessing
                                ? 'bg-gray-800 border-2 border-gray-700 text-gray-400 cursor-wait justify-center'
                                : canAfford
                                ? 'bg-gradient-to-b from-[#3d2410] via-[#241407] to-[#120a03] hover:from-[#4d2d14] hover:via-[#2e1909] hover:to-[#170c04] border-t-2 border-t-amber-400/90 border-x border-amber-600/50 border-b-2 border-b-black shadow-[0_4px_12px_rgba(0,0,0,0.8),0_0_12px_rgba(245,158,11,0.2)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.9),0_0_18px_rgba(245,158,11,0.35)] hover:scale-[1.01] active:scale-[0.98]'
                                : 'bg-amber-950/40 border border-amber-500/40 text-amber-300/80 hover:bg-amber-900/50'
                            }`}
                          >
                            {isProcessing ? (
                              <span>ASCENDING...</span>
                              ...
                              <>
                                ...
                                <div className="bg-black/60 border border-amber-500/40 rounded-lg px-2.5 py-1 flex items-center gap-1.5 shadow-inner">
                                  <img src="/icons/icon_shards.webp" alt="Shards" className="w-4 h-4 object-contain filter drop-shadow-[0_0_6px_rgba(244,63,94,0.95)]" />
                                  <span className="font-mono font-bold text-amber-300 text-xs sm:text-sm tracking-normal">{cost.toLocaleString()} SHARDS</span>
                                </div>
                              </>
                            )}
                          </button>
                          ...
                          <button
                            ...
                            className={`w-full relative overflow-hidden py-2.5 px-3.5 rounded-xl font-display font-black text-xs sm:text-sm tracking-widest uppercase flex items-center justify-between transition-all duration-200 cursor-pointer select-none group ${
                              isProcessing
                                ? 'bg-gray-800 border-2 border-gray-700 text-gray-400 cursor-wait justify-center'
                                : canAfford
                                ? 'bg-gradient-to-b from-[#4e101d] via-[#2d0710] to-[#140206] hover:from-[#611424] hover:via-[#390914] hover:to-[#1a0308] border-t-2 border-t-rose-400/90 border-x border-rose-500/50 border-b-2 border-b-black shadow-[0_4px_12px_rgba(0,0,0,0.8),0_0_12px_rgba(244,63,94,0.2)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.9),0_0_18px_rgba(244,63,94,0.35)] hover:scale-[1.01] active:scale-[0.98]'
                                : 'bg-rose-950/40 border border-rose-500/40 text-rose-300/80 hover:bg-rose-900/50'
                            }`}
                          >
                            {isProcessing ? (
                              <span>ASCENDING...</span>
                              ...
                              <>
                                ...
                                <div className="bg-black/60 border border-rose-500/40 rounded-lg px-2.5 py-1 flex items-center gap-1.5 shadow-inner">
                                  <img src="/icons/icon_shards.webp" alt="Shards" className="w-4 h-4 object-contain filter drop-shadow-[0_0_6px_rgba(244,63,94,0.95)]" />
                                  <span className="font-mono font-bold text-rose-300 text-xs sm:text-sm tracking-normal">{cost.toLocaleString()} SHARDS</span>
                                </div>
                              </>
                            )}
                          </button>
