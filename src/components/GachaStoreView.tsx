          ...
          {activeCategory === 'level_boost' && (
            <div className="space-y-3.5 sm:space-y-4 animate-fade-in">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-amber-500/20 pb-2.5">
                <div className="flex items-center gap-2.5">
                  <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-amber-500/20 via-black to-amber-950/50 border border-amber-400/50 flex items-center justify-center shadow-[0_0_16px_rgba(245,158,11,0.3)] shrink-0 overflow-hidden">
                    <img
                      src="/shop/ascension_sigil.png"
                      alt="Ascension Sigil"
                      className="w-7 h-7 object-contain drop-shadow-[0_0_8px_rgba(245,158,11,0.8)]"
                    />
                  </div>
                  <div>
                    ...
                    <p className="text-[10px] sm:text-[11px] text-gray-400 font-mono leading-none mt-0.5">
                ...
                {(() => {
                  ...
                  return (
                    <div className={`rounded-2xl border-2 p-3.5 sm:p-4 flex flex-col justify-between relative overflow-hidden transition-all duration-300 ${
                      ...
                      <div className="space-y-3 relative z-10">
                        {/* Top Tier Tag */}
                        <div className="flex items-center justify-between text-[8.5px] sm:text-[9px] font-mono font-bold tracking-wider text-amber-400/90 uppercase px-1">
                          <span className="flex items-center gap-1.5">
                            <span className="w-1.5 h-1.5 rounded-full bg-amber-400 animate-pulse" />
                            ASCENDANT CHAMPION
                          </span>
                        ...
                        <div className="flex items-center gap-3.5">
                          <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-xl bg-gradient-to-b from-amber-500/15 via-black to-black border-2 border-amber-400/60 p-1 flex items-center justify-center shrink-0 shadow-[0_0_20px_rgba(245,158,11,0.3)] group-hover:scale-105 group-hover:border-amber-400 transition-all">
                            <img
                          ...
                          <div className="min-w-0">
                            ...
                            <h3 className="font-display font-black text-base sm:text-lg text-white uppercase tracking-wider group-hover:text-amber-200 transition-colors">
                              Instant Level 50
                            </h3>
                        ...
                        <div className="bg-black/65 border border-white/10 rounded-xl p-2.5 sm:p-3 text-[11px] font-mono space-y-1.5 shadow-inner">
                          <div className="flex justify-between items-center text-[9.5px] text-gray-400 uppercase tracking-wider font-bold border-b border-white/10 pb-1">
                            <span className="flex items-center gap-1.5 text-amber-400">
                              <span className="w-1.5 h-1.5 rounded-full bg-amber-400" />
                              Hero Progression
                            </span>
                            <span className="text-amber-400 font-bold text-[8.5px] bg-amber-950/80 border border-amber-500/40 px-1.5 py-0.2 rounded">INSTANT</span>
                          </div>
                          <div className="flex justify-between items-center">
                            <span className="text-gray-300 flex items-center gap-1.5">
                            ...
                            <span className="text-white font-bold text-xs bg-amber-950/60 px-1.5 py-0.5 rounded border border-amber-500/40">
                              Level 50
                            </span>
                          </div>
                          <div className="flex justify-between items-center">
                            ...
                            <span className="text-amber-300 font-bold text-xs bg-amber-950/60 px-1.5 py-0.5 rounded border border-amber-500/40">
                              +49 Points
                            </span>
                          </div>
                          <div className="flex justify-between items-center">
                            ...
                            <span className="text-emerald-300 font-bold text-xs bg-emerald-950/60 px-1.5 py-0.5 rounded border border-emerald-500/40">
                              128 HP
                            </span>
                          </div>
                        </div>
                      ...
                      <div className="mt-3.5 pt-2.5 border-t border-white/10 relative z-10">
                        {isAlreadyReached ? (
                          <div className="w-full py-2.5 px-3 rounded-xl bg-white/5 border border-white/10 text-gray-400 font-display font-black text-xs uppercase tracking-widest text-center">
                            ✓ ALREADY LEVEL 50+
                          </div>
                        ) : (
                          <button
                ...
                {(() => {
                  ...
                  return (
                    <div className={`rounded-2xl border-2 p-3.5 sm:p-4 flex flex-col justify-between relative overflow-hidden transition-all duration-300 ${
                      ...
                      <div className="absolute bottom-0 left-0 w-40 h-40 bg-purple-600/15 rounded-full blur-2xl pointer-events-none" />

                      <div className="space-y-3 relative z-10">
                        {/* Top Tier Tag */}
                        <div className="flex items-center justify-between text-[8.5px] sm:text-[9px] font-mono font-bold tracking-wider text-rose-400/90 uppercase px-1">
                          <span className="flex items-center gap-1.5">
                            <span className="w-1.5 h-1.5 rounded-full bg-rose-400 animate-pulse" />
                            SUPREME GODHOOD
                          </span>
                        ...
                        <div className="flex items-center gap-3.5">
                          <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-xl bg-gradient-to-b from-rose-900/40 via-purple-950/60 to-black border-2 border-rose-400/80 p-1 flex items-center justify-center shrink-0 shadow-[0_0_25px_rgba(244,63,94,0.4)] group-hover:scale-105 group-hover:border-rose-400 transition-all">
                            <img
                          ...
                          <div className="min-w-0">
                            ...
                            <h3 className="font-display font-black text-base sm:text-lg text-transparent bg-clip-text bg-gradient-to-r from-white via-rose-100 to-amber-200 uppercase tracking-wider group-hover:from-rose-200 group-hover:to-amber-300 transition-all">
                              Instant Level 100
                            </h3>
                            <p className="text-[10px] text-gray-400 font-sans leading-tight mt-0.5">
                        ...
                        <div className="bg-black/65 border border-white/10 rounded-xl p-2.5 sm:p-3 text-[11px] font-mono space-y-1.5 shadow-inner">
                          <div className="flex justify-between items-center text-[9.5px] text-gray-400 uppercase tracking-wider font-bold border-b border-white/10 pb-1">
                            ...
                            <span className="text-rose-300 font-bold text-[8.5px] bg-rose-950/80 border border-rose-500/40 px-1.5 py-0.2 rounded">MAX CAP</span>
                          </div>
                          <div className="flex justify-between items-center">
                            <span className="text-gray-300 flex items-center gap-1.5">
                            ...
                            <span className="text-white font-bold text-xs bg-rose-950/60 px-1.5 py-0.5 rounded border border-rose-500/40 shadow">
                              Level 100 (MAX)
                            </span>
                          </div>
                          <div className="flex justify-between items-center">
                            ...
                            <span className="text-amber-300 font-bold text-xs bg-rose-950/60 px-1.5 py-0.5 rounded border border-rose-500/40 shadow">
                          ...
                          <div className="flex justify-between items-center">
                            ...
                            <span className="text-emerald-300 font-bold text-xs bg-emerald-950/60 px-1.5 py-0.5 rounded border border-emerald-500/40 shadow">
                              228 HP
                            </span>
                          </div>
                        </div>
              ...
              {/* Bottom Note */}
              <div className="bg-gradient-to-r from-amber-950/20 via-[#0a0705] to-black border border-amber-500/30 rounded-xl px-3 py-2.5 sm:px-4 sm:py-3 flex items-center gap-3 shadow-md">
                <span className="w-2 h-2 rounded-full bg-amber-400 animate-pulse shadow-[0_0_8px_rgba(245,158,11,0.9)] shrink-0" />
                <p className="font-mono text-[10.5px] sm:text-[11.5px] text-gray-300 leading-tight">
