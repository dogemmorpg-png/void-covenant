...
export const CampaignView: React.FC<CampaignViewProps> = ({ onStartBattle }) => {
  ...
  return (
    <div className="max-w-5xl mx-auto p-4 flex items-center justify-center min-h-[calc(100vh-220px)] animate-fadeIn">
      ...
      <div className={`glass-panel rounded-3xl pt-6 px-8 pb-3.5 w-full relative overflow-hidden flex flex-col justify-between ${
        isBoss 
        ...
        <div className="relative z-10 flex flex-col justify-between h-full space-y-3.5">
          ...
          <div className="text-center border-b border-gray-800/80 pb-3 flex flex-col items-center">
          ...
          <div className="flex justify-center items-center py-1.5">
            <div className="flex items-center gap-8 bg-black/40 border border-gray-800/50 rounded-[32px] py-3.5 px-8 shadow-inner">
              <button 
                onClick={handlePrev}
                disabled={viewingFloor === 1}
                className="p-3.5 rounded-2xl bg-black/40 border border-[#ebd09b]/25 hover:border-[#ebd09b]/60 text-[#ebd09b] hover:bg-[#ebd09b]/10 disabled:opacity-20 disabled:pointer-events-none transition-all cursor-pointer shadow-md"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-2">
            ...
            <div className="space-y-2">
              ...
              <div className="bg-black/50 border border-gray-800/60 rounded-2xl p-4.5 flex items-center gap-4 shadow-inner min-h-[105px]">
                ...
                <div>
                  ...
                  <p className="text-xs font-mono text-gray-400 mt-2">Hero Health: <span className="text-[#dd2c40] font-bold">{selectedStage.enemyHeroHealth} HP</span></p>
            ...
            <div className="space-y-2">
              ...
              <div className="bg-black/50 border border-gray-800/60 rounded-2xl p-3.5 flex items-center justify-around gap-2 shadow-inner min-h-[105px]">
          ...
          {selectedStage.cardReward && (
            <div className="bg-black/50 border border-emerald-500/20 p-3.5 rounded-2xl flex items-center justify-between shadow-inner mb-1.5">
          ...
          <div className="pt-3 border-t border-gray-800/80 flex flex-col items-center">
            <div className="flex w-full max-w-xl gap-5">
              <button
                onClick={handleStart}
                className={`flex-1 font-display font-bold tracking-widest py-3.5 px-6 rounded-xl transition-all duration-300 flex items-center justify-center gap-4 cursor-pointer hover:scale-[1.02] active:scale-[0.98] text-sm uppercase ${
                  isBoss 
              ...
              >
                ...
                <span className={`flex items-center gap-1.5 bg-black/50 border rounded-full px-3 py-0.5 font-mono text-lg font-bold text-emerald-400 shadow-inner ${
                  isBoss ? 'border-red-500/30' : 'border-[#ebd09b]/35'
                }`}>
                  {selectedStage.energyCost}
                  <img src="/icons/icon_energy.webp" alt="Energy" className="w-6 h-6 object-contain brightness-110 drop-shadow-[0_0_6px_rgba(16,185,129,0.45)]" />
                </span>
              </button>
              ...
              {stageStars === 3 && (
                <button
                  onClick={handleSweep}
                  className="flex-1 font-display font-bold tracking-widest py-3.5 px-6 rounded-xl transition-all duration-300 flex items-center justify-center gap-4 cursor-pointer hover:scale-[1.02] active:scale-[0.98] text-sm uppercase bg-gradient-to-b from-[#1b122c] via-[#0e071a] to-[#06020c] border-2 border-purple-600/50 hover:border-purple-400 text-purple-400 hover:text-white shadow-[0_0_15px_rgba(147,51,234,0.15)] hover:shadow-[0_0_25px_rgba(168,85,247,0.35)]"
                >
                  <FastForward className="w-5 h-5" /> 
                  <span className="mr-0.5">SWEEP</span>
                  <span className="flex items-center gap-1.5 bg-black/50 border border-purple-500/30 rounded-full px-3 py-0.5 font-mono text-lg font-bold text-emerald-400 shadow-inner">
                    {selectedStage.energyCost}
                    <img src="/icons/icon_energy.webp" alt="Energy" className="w-6 h-6 object-contain brightness-110 drop-shadow-[0_0_6px_rgba(16,185,129,0.45)]" />
                  </span>
                </button>
