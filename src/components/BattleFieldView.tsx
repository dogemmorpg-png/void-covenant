                    ...
                    {card ? (
                      ...
                      >
                        ...
                        <div className="absolute -bottom-3.5 -left-3.5 w-9 h-9 z-20 flex items-center justify-center">
                          ...
                          <span className="relative text-[#ff9f0a] text-[15px] font-black font-mono leading-none select-none z-10" style={{ WebkitTextStroke: '2px #000000', paintOrder: 'stroke fill' }}>{card.attack}</span>
                        </div>
            ...
            >
              ...
              >
                ...
                <div className="absolute -bottom-3 -left-3 w-8 h-8 z-20 flex items-center justify-center">
                  <img src="/icons/gothic_attack.jpg" alt="ATK" className="absolute inset-0 w-full h-full object-cover rounded-lg border border-zinc-700/50 shadow-md" />
                  <span className="relative text-[#ff9f0a] text-[13.5px] font-black font-mono leading-none z-10" style={{ WebkitTextStroke: '1.8px #000000', paintOrder: 'stroke fill' }}>{hoveredCard.attack}</span>
                </div>
