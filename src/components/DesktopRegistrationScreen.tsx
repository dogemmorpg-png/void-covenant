...
export const DesktopRegistrationScreen: React.FC<RegistrationScreenProps> = ({ onRegister }) => {
              ...
              return (
                <div
                  ...
                  className={`group relative cursor-pointer rounded-xl overflow-hidden border-2 transition-all duration-300 aspect-[4/5] flex flex-col justify-end p-1.5 ${
                    isSelected
                      ? 'border-[#ebd09b] shadow-[0_0_20px_rgba(235,208,155,0.6)] scale-[1.02] bg-gradient-to-t from-black via-black/40 to-transparent'
