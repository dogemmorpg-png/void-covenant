...
export const CARD_TEMPLATES: CardTemplate[] = [
  ...
  },
  {
    ...
    delay: 1,
    skills: [],
    image: '/cards/grave_hound.png',
    color: 'slate',
    description: 'A loyal hunter of the graveyard, possessing simple but lethal claws.'
  },
  {
    baseId: 'zombie_footsoldier',
    name: 'Zombie Footsoldier',
    tier: 'bronze',
    attack: 4,
    health: 14,
    delay: 2,
    skills: [],
    image: '/cards/zombie_footsoldier.png',
    color: 'slate',
    description: 'A slow but heavily built corpse clad in rusted iron armor.'
  },
  {
    ...
    color: 'emerald',
    description: 'A hard-shelled insect that relies on brute swarm strength.'
  },
  {
    baseId: 'blood_guard',
    name: 'Blood Guard',
    ...
    delay: 2,
    skills: [],
    image: '/cards/blood_guard.png',
    color: 'crimson',
    description: 'A stout defender of the covenant chambers, standing as a solid wall.'
  },
  {
    baseId: 'cave_bat',
    name: 'Cave Bat',
    ...
    delay: 1,
    skills: [],
    image: '/cards/cave_bat.png',
    color: 'amber',
    description: 'A giant winged dweller of dark caverns, striking with swift ferocity.'
  },
  {
    baseId: 'stone_gargoyle',
    name: 'Stone Gargoyle',
    tier: 'bronze',
    attack: 5,
    health: 11,
    delay: 2,
    skills: [],
    image: '/cards/stone_gargoyle.png',
    color: 'slate',
    description: 'A solid gargoyle carved from obsidian, crushing foes with sheer weight.'
  },
  {
    baseId: 'swamp_beast',
    name: 'Swamp Beast',
    ...
    delay: 3,
    skills: [],
    image: '/cards/swamp_beast.png',
    color: 'emerald',
    description: 'A massive marsh monster, a mindless brute of the swamplands.'
  },
  {
    baseId: 'dread_knight',
    name: 'Dread Knight',
    ...
    delay: 2,
    skills: [],
    image: '/cards/dread_knight.png',
    color: 'slate',
    description: 'A fallen knight whose sword strikes with raw, unholy strength.'
  },
  {
    baseId: 'flesh_gorgon',
    name: 'Flesh Gorgon',
    ...
    delay: 3,
    skills: [],
    image: '/cards/flesh_gorgon.png',
    color: 'crimson',
    description: 'A towering wall of raw muscle and stitched skin, absorbing heavy damage.'
  },
  {
    baseId: 'tomb_guardian',
    name: 'Tomb Guardian',
    tier: 'silver',
    attack: 4,
    health: 16,
    delay: 1,
    skills: [],
    image: '/cards/tomb_guardian.png',
    color: 'amber',
    description: 'An ancient stone statue that swings a giant claymore with great speed.'
  },
  {
    ...
    color: 'violet',
    description: 'A terrifying shadow assassin that hunts silently in the dark.'
  },
  {
    baseId: 'crypt_abomination',
    ...
    delay: 3,
    skills: [],
    image: '/cards/crypt_abomination.png',
    color: 'slate',
    description: 'An enormous horror stitched together from dozens of corpses, a pure titan.'
  },
  {
    baseId: 'void_behemoth',
    name: 'Void Behemoth',
    tier: 'gold',
    attack: 10,
    health: 45,
    delay: 4,
    skills: [],
    image: '/cards/void_behemoth.png',
    color: 'violet',
    description: 'A gigantic entity summoned from the deepest void, crushing everything in its path.'
  },
  {
    baseId: 'grave_titan',
    name: 'Grave Titan',
    ...
    delay: 2,
    skills: [],
    image: '/cards/grave_titan.png',
    color: 'slate',
    description: 'A colossal skeletal giant that tramples armies with its massive footsteps.'
  },
  {
    baseId: 'the_ancient_one',
    ...
    delay: 4,
    skills: [],
    image: '/cards/the_ancient_one.png',
    color: 'cyan',
    description: 'A primordial lord of darkness. Pure raw power, unbound by spellcraft.'
  }
];
